...
const Pricing = () => {
  ...
  const plans = [
    { name: "Starter", price: "39 €", per: "/Monat", setup: "zzgl. 399 € Einrichtung", recommended: true, soon: false, features: ["Vollständig anpassbares Branding", "Bis zu 100 Weine im Katalog", "Direkte Shop-Integration", "Quiz-Editor", "E-Mail Support"], cta: "Jetzt anfragen" },
    { name: "Professional", price: "79 €", per: "/Monat", setup: "zzgl. 399 € Einrichtung", recommended: false, soon: true, features: ["Alles aus Starter", "Bis zu 500 Weine", "A/B Testing", "Lead-Capture & CRM-Export", "Priority Support"], cta: "Demnächst verfügbar" },
