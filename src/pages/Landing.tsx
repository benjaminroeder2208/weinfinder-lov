...
const Pricing = () => {
  ...
  const plans = [
    ...
    { name: "Professional", price: "79 €", per: "/Monat", setup: "zzgl. 349 € Einrichtung", recommended: false, soon: true, features: ["Alles aus Starter", "Bis zu 500 Weine", "A/B Testing", "Lead-Capture & CRM-Export", "Priority Support"], cta: "Demnächst verfügbar" },
