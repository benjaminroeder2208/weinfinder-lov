  ...
  <nav className="sticky top-0 z-50 backdrop-blur-md border-b" style={{ backgroundColor: `${COLORS.bg}ee`, borderColor: "rgba(44,31,14,0.08)" }}>
    <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center gap-8 text-sm" style={{ fontFamily: fontStack.body, color: COLORS.text }}>
        <a href="#how" className="hover:opacity-70 transition">Wie es funktioniert</a>
        <a href="#features" className="hover:opacity-70 transition">Features</a>
        <a href="#pricing" className="hover:opacity-70 transition">Preise</a>
      </div>
      <Link to="/demo" className="px-5 py-2.5 rounded-md text-sm font-semibold text-white hover:opacity-90 transition" style={{ backgroundColor: COLORS.primary, fontFamily: fontStack.body }}>
        Demo starten
      </Link>
    </div>
  </nav>
